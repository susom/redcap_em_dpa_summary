...
// end starr nav
        ...
        $ldapUrl = "http://127.0.0.1:8080/webtools/redcap-ldap/redcap_validator_web_service.php?token=$token&exact=true&only=displayname,sudisplaynamefirst,sudisplaynamelast,sudisplaynamelf,mail,telephonenumber,suaffiliation,sugwaffiliation1,ou,telephonenumber,suprimaryorganizationid,susunetid&username=";
